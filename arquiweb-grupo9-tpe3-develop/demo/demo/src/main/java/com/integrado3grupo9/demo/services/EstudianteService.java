...
public class EstudianteService {
    ...
    /*
     * Este metodo busca los estudiantes ordenados por algun criterio establecido. El objeto Sort de Spring Boot permite
     * definir como ordenar (desc o asc) y por cual columna de nuestra entidad. Esta variante de findAll(Sort sort)
    ...
    public Estudiante findByNroLibreta(Long nroLibreta) {
        return this.repository.findByNroLibreta(nroLibreta).orElse(null);
    }
